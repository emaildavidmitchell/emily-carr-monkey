...
class SlicesTestCase(unittest.TestCase):
    def test_getslice_cint(self):
        a = (c_int * 100)(*list(range(1100, 1200)))
    ...
    def test_setslice_cint(self):
        ...
        a[32:47] = list(range(132, 147))
        self.assertEqual(a[32:47:], list(range(132, 147)))
        a[46:31:-1] = list(range(232, 247))
        self.assertEqual(a[32:47:1], list(range(246, 231, -1)))

        a[32:47] = list(range(1132, 1147))
        self.assertEqual(a[:], b)
        a[32:47:7] = list(range(3))
        b[32:47:7] = list(range(3))
        self.assertEqual(a[:], b)
        a[33::-3] = list(range(12))
        b[33::-3] = list(range(12))
        self.assertEqual(a[:], b)
        ...
        self.assertRaises(ValueError, setitem, a, slice(0, 5), list(range(32)))
