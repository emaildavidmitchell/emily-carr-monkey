...
class GrammarTests(unittest.TestCase):
    ...
    def testFuncdef(self):
        ...
        if sys.platform.startswith('java'):
            self.assertEqual(f4.__code__.co_varnames,
                   ('two', '(compound, (argument, list))', 'compound', 'argument',
                                'list',))
            self.assertEqual(f5.__code__.co_varnames,
        ...
        if sys.platform.startswith('java'):
            self.assertEqual(v3.__code__.co_varnames, ('a', '(b, c)', 'rest', 'b', 'c'))
        else:
            self.assertEqual(v3.__code__.co_varnames, ('a', '.1', 'rest', 'b', 'c'))
