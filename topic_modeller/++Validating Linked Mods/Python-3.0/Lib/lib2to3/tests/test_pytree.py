...
class TestNodes(support.TestCase):
    ...
    def testNodeNextSibling(self):
        ...
        self.assertTrue(n1.get_next_sibling() is n2)
    ...
    def testLeafNextSibling(self):
        ...
        self.assertTrue(l1.get_next_sibling() is l2)
    ...
    def testNodePrevSibling(self):
        ...
        self.assertTrue(n2.get_prev_sibling() is n1)
    ...
    def testLeafPrevSibling(self):
        ...
        self.assertTrue(l2.get_prev_sibling() is l1)
